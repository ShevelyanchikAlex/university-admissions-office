package com.epam.admissions.office.universityadmissionsoffice.entity;
...
public class Application implements Serializable {
    ...
    public Application(int applicationId, Date applyDate, boolean isApproved, Date decisionDate,
                       String rejectionReason, int userId, int facultyId) {
